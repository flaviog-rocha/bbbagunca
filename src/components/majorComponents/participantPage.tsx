...
import ParticipantInfo from "@/components/minorComponents/ParticipantInfo";
import ParticipantAffinity from "@/components/minorComponents/ParticipantAffinity";
import CicleInfo from "@/components/minorComponents/CicleInfo";

import Camila from "../../../public/img/full-pic/Phelipe.png"
...
export default function ParticipantPage({participantName}: name){
            ...
            <div className="h-96 w-full bg-purpleThemeLighter flex">
                ...
                <div className="h-96 w-240 overflow-hidden">
                    ...
                    <Image 
                        width={1000} 
                        height={1000} 
                        alt={`Participante ${participantName}`} 
                        src={image}
                        style={{
                            marginTop: '-50px'
                        }}
